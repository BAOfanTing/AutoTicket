...
8.14 成功,响应显示,解决数字签名错误问题,回应变为,积分兑换-活动购买失败
...
又再一次会看b775函数,通道是02,难不成公钥,得使用这个![image-20250814132107304](./image/image-20250814132107304.png)

替换后运行,果然成功了,成功显示了`手慢,优惠券被抢光`和点击的效果一致

![image-20250814132451293](./image/image-20250814132451293.png)
